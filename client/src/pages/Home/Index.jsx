    ...
    <div className='h-screen w-full bg-gray-200 flex overflow-hidden'>
        ...
        <div className='w-[20%] bg-white'>
            <div className='h-[30%] flex justify-center items-center border-b'>
                <div className='flex flex-col items-center'>
                    ...
                    <p className='mb-4 text-center'>@username_here</p>
            ...
            <div className='h-[55%] flex flex-col justify-evenly pl-12 border-b'>
                <div className='flex items-center space-x-2 cursor-pointer hover:text-gray-500 border-b p-3'>
                    <IconNews size={30}/>
                ...
                <div className='flex items-center space-x-2 cursor-pointer hover:text-gray-500 border-b p-3'>
                    ...
                    <span className='font-bold text-xl'>Direct</span>
                </div>
                <div className='flex items-center space-x-2 cursor-pointer hover:text-gray-500 border-b p-3'>
                    <IconUser size={30}/>
        ...
        <div className='w-[60%] overflow-scroll h-full scrollbar-hide'>
            <div className='bg-white h-[75px] border-l flex justify-evenly pt-4 items-center sticky top-0 shadow-lg'>
                ...
                <Button label='Create new Post' className='rounded bg-red-600 hover:bg-red-500 mb-4 ml-12 '/>
            </div>
                    ...
                    return(
                        <div className='bg-white w-[78%] mx-auto mt-32 p-8 rounded-md'>
                            <div className='border-b flex items-center pb-4 mb-4'>
                                ...
                                <div className='ml-4'>
                                    <h3 className='font-bold text-xl'>Name here</h3>
                                    <p>@Username_here</p>
                                </div>
                            </div>
                            <div className='border-b pb-4 mb-2'>
                                <img src={postImg} alt="Failed to load image" className='w-full rounded-lg'/>
                            </div>
                            <div className='border-b pb-2'>
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas, ad. Saepe labore molestias obcaecati qui! Consequuntur fuga iste deleniti. Velit itaque delectus rerum incidunt aut aliquam aliquid odio! Minima possimus quod nostrum eius. Velit.
                            </div>
                            <div className='flex justify-evenly font-bold mt-2'>
                                ...
                                <div className='flex items-center'>
                                    <IconShare size={24} className='mr-2' cursor='pointer'/> 
                                    <span>10.5K Shares</span>
                                </div>
                                <div className='flex items-center'>
                                    <IconBookmark size={24} className='mr-2' cursor='pointer'/> 
                                    <span>10.5K Shares</span>
                                </div>
                            </div>
                        </div>
